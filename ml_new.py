...
def build_model(df):
    ...
    criterion=parameter_criterion,  # This should now be 'squared_error' or 'absolute_error'
...
if uploaded_file is not None:
    ...
    if st.button('Press to use Example Dataset'):
        ...
        st.markdown('The fetch california housing dataset is used as the example.')
        st.write(df.head(5))
